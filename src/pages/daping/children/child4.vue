<template>
    <div class="wrap">
        <div class="main">
            ...
            <div class="item2">
                <div class="top">
                    <span :class="{'danwei':index===0}" v-for="(item,index) in child4Data.gtype" :key="index">{{item}}</span>
                </div>
                <div class="list-wrap">
                   
                    <div class="list" id="move-list-item4">
                        <div class="item" v-for="(item,index) in child4Data.data" :key="index">
...
export default {
    ...
    methods:{
        ...
        chart(){
            ...
            var XName= that.child4Data.sname
            // ["周一","周二","周三","周四","周五","周六","周日"]
            var data1 = that.child4Data.datas
            // [
            ...
            //         ]
            var Line =that.child4Data.gtype;
            // that.child4Data.gtype;
            // ["云篆山水路线","昕博朗学校路线","新华小学路线","云锦五路路线"];
            var img = [
