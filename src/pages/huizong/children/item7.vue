    ...
    export default {
        ...
        methods:{
            ...
            getDataLeft(){
              ...
              this.$axios({
                  url:'http://s.tronl.cn/weixin/project/index.php?m=home&c=Index&a=last_week',
                  method:'POST',
                  changeOrigin:true,
                  data:params
              }).then((data)=>{
             ...
             getDataCenter(){
              ...
              params.append('token',token)
              this.$axios({
                  url:'http://s.tronl.cn/weixin/project/index.php?m=home&c=Index&a=out_work',
                  method:'POST',
                  changeOrigin:true,
                  data:params
              }).then((data)=>{
             ...
             getDataRight(){
              ...
              params.append('token',token)
              this.$axios({
                  url:'http://s.tronl.cn/weixin/project/index.php?m=home&c=Index&a=out_device',
                  method:'POST',
                  changeOrigin:true,
                  data:params
              }).then((data)=>{
