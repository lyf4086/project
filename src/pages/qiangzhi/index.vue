...
export default {
  ...
  methods: {
    ...
    search(n = 1, val = "", state = false, gun_id) {
      ...
      this.$axios({
        url:
          "http://s.tronl.cn/weixin/project/index.php?m=home&c=search&a=guns",
        method: "POST",
        changeOrigin: true,
        data: params
      })
    ...
    subChange() {
      ...
      this.$axios({
        url:
          "http://s.tronl.cn/weixin/project/index.php?m=home&c=gun&a=rewrite",
        method: "POST",
        changeOrigin: true,
        data: params
      })
    ...
    addGun() {
      ...
      this.$axios({
        url:
          "http://s.tronl.cn/weixin/project/index.php?m=home&c=policeuser&a=policeusers",
        method: "POST",
        changeOrigin: true,
        data: params
      })
    ...
    deleteData(idStr) {
      ...
      params.append("token", token);
      this.$axios({
        url: "http://s.tronl.cn/weixin/project/index.php?m=home&c=gun&a=del",
        method: "POST",
        changeOrigin: true,
        data: params
      })
